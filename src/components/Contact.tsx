...
type ContactDetail = {
  ...
  content: ReactNode
  icon: ReactNode
  /** Omitted for rows there is nothing to act on — the opening hours. */
  href?: string
}
          ...
          >
            <div className="space-y-7">
              {contactDetails.map((detail) => {
                // tel: and mailto: hand off to another app and must stay in
                // this tab; only the map is a page worth opening beside us.
                const opensElsewhere = detail.href?.startsWith('http')
